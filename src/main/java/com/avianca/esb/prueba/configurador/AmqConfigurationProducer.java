 ...
 */
package com.avianca.esb.prueba.configurador;
...
import com.avianca.esb.prueba.properties.AmqProducerBase;
...
public class AmqConfigurationProducer {
    ...
    @Autowired
    private AmqProducerBase producer;
	...
	@Bean(name = "activemqproducer-component")
